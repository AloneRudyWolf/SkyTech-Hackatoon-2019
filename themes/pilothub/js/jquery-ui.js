...
function Datepicker() {
	...
	this.regional[ "ru" ] = { // Default regional settings
		...
		monthNamesShort: [ "Янв", "Фев", "Март", "Апрл", "Май", "Июн", "Июл", "Авг", "Сент", "Окт", "Нояб", "Дек" ], // For formatting
		dayNames: [ "Воскресенье", "Поенедельник", "Вторник", "Среда", "Четверг", "Пятница", "Суббота" ], // For formatting
